...
export const App: FC<{}> = props =>
{
    ...
    const [ message, setMessage ] = useState('Valmistellaan');
    ...
    const handler = useCallback(async (event: NitroEvent) =>
    {
        switch(event.type)
        {
            ...
            case ConfigurationEvent.FAILED:
                setIsError(true);
                setMessage('Asetusten lataus epäonnistui');
                return;
            case Nitro.WEBGL_UNAVAILABLE:
                setIsError(true);
                setMessage('WebGL vaaditaan');
                return;
            case Nitro.WEBGL_CONTEXT_LOST:
                setIsError(true);
                setMessage('WebGL-yhteys katkaistu – ladataan uudelleen');
            ...
            case NitroCommunicationDemoEvent.CONNECTION_HANDSHAKE_FAILED:
                setIsError(true);
                setMessage('Websocket-handshake epäonnistui');
                return;
            ...
            case NitroLocalizationEvent.LOADED: {
                ...
                {
                    setIsError(true);
                    setMessage('Assettien lataus epäonnistui');
                }
                return;
            }
        }
